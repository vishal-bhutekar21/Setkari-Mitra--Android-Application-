...
public class ExpandableListAdapter2 extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapter2(Context context, List<String> listDataHeader, HashMap<String, List<ChildItem>> listHashMap) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView childDescriptionTextView = convertView.findViewById(R.id.childDescriptionTextView);
